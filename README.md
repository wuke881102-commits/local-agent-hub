...
<p align="center"><sub>本地邮箱 —— 选邮箱、看多久、三视图，以及三类桶「需我回复 / 待我处理 / 知会即可」。页脚如实写明这一趟给模型发了多少。<b>图中人名、主题、数字全为虚构示例</b></sub></p>
...
<p align="center"><sub>个人摘记 —— 间隔、采集来源，以及合并成一段话的摘记记录（不是罗列流水）。<b>图中人名、内容、数字全为虚构示例</b></sub></p>
